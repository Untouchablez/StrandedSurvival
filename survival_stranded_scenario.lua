...
ScenarioInfo = {
    ...
    starts = true,
    size = {1024, 1024},
    reclaim = {754812, 7048.156},
    map = '/maps/survival_stranded.v0018/survival_stranded.scmap',
    save = '/maps/survival_stranded.v0018/survival_stranded_save.lua',
    script = '/maps/survival_stranded.v0018/survival_stranded_script.lua',
    norushradius = 40,
    Configurations = {
        ['standard'] = {
            teams = {
