...
ScenarioInfo = {
    ...
    size = {1024, 1024},
    reclaim = {560862.1, 0},
    map = '/maps/survival_stranded.v0015/survival_stranded.scmap',
    save = '/maps/survival_stranded.v0015/survival_stranded_save.lua',
    script = '/maps/survival_stranded.v0015/survival_stranded_script.lua',
    norushradius = 40,
    Configurations = {
        ['standard'] = {
            teams = {
