...
ScenarioInfo = {
    ...
    map = '/maps/survival_stranded.v0017/survival_stranded.scmap',
    save = '/maps/survival_stranded.v0017/survival_stranded_save.lua',
    script = '/maps/survival_stranded.v0017/survival_stranded_script.lua',
    norushradius = 40,
    Configurations = {
        ['standard'] = {
            teams = {
