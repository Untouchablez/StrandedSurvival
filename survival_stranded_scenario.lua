...
ScenarioInfo = {
    ...
    starts = true,
    size = {1024, 1024},
    reclaim = {769229.5, 7048.156},
    map = '/maps/survival_stranded.v0020/survival_stranded.scmap',
    save = '/maps/survival_stranded.v0020/survival_stranded_save.lua',
    script = '/maps/survival_stranded.v0020/survival_stranded_script.lua',
    norushradius = 40,
    Configurations = {
        ['standard'] = {
            teams = {
