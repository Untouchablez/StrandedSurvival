...
local Platoons = import("/maps/survival_stranded.v0019/Platoons.lua")
local Drops = import("/maps/survival_stranded.v0019/Drops.lua")
local NavyPlatoons = import("/maps/survival_stranded.v0019/Navyplatoons.lua")
local Navyattack = import("/maps/survival_stranded.v0019/Navyattack.lua")
local LandPlatoons = import("/maps/survival_stranded.v0019/Landplatoons.lua")
local Landattack = import("/maps/survival_stranded.v0019/Landattack.lua")
local Defaultoptions = import("/maps/survival_stranded.v0019/Defaultoptions.lua")
local Defenceobject = import("/maps/survival_stranded.v0019/Defenceobject.lua")
--local EnemyAI = import("/maps/survival_stranded.v0019/EnemyAI.lua")
local allfactions = import("/maps/survival_stranded.v0019/Allfactions.lua")
local Gates = import("/maps/survival_stranded.v0019/Gates.lua")
...
local GameTime = import("/maps/survival_stranded.v0019/GameTime.lua")
...
function OnStart(self)
   ...
   ----
    ...
    -- other scripts
	doscript("/maps/survival_stranded.v0019/PlayableArea.lua")
    doscript("/maps/survival_stranded.v0019/message.lua")
    doscript("/maps/survival_stranded.v0019/AIHelp.lua")
    doscript("/maps/survival_stranded.v0019/EnemyAI.lua")
    --doscript("/maps/survival_stranded.v0019/.lua")
